...
### ⏭ 仅博客 / 不发跨平台(2026-09-22)

| 平台 | 资源 | 备注 |
|---|---|---|
| **博客** | `src/content/blog/obsidian-sync-guide.md`(8.8KB) | Neo 9/22 决定:跟 obsidian-overview 主题强关联,只发博客 |

**跳过原因**:虽然跟 obsidian-overview 是"全景 vs 实操"的互补姊妹篇,但主题都是 Obsidian,按 Neo 9/15 的"内容够不够新"标准判断,跨平台分发价值有限。仅博客就够。

### ⏭ 仅博客 / 不发跨平台(2026-09-15)

| 平台 | 资源 | 备注 |
|---|---|---|
| **博客** | `src/content/blog/agent-skills.md`(12.2KB) | Neo 9/15 决定:内容不够新,只发博客 |

**跳过原因**:Agent Skills 9/15 上线时内容跟之前的 Vibe Coding / Hermes 高度重叠(都是讲 AI 编程能力),跨平台分发价值有限。仅博客就够。
...
### 2026-09-15 (2) — Agent Skills 仅博客
- 🆕 **新发 1 篇博客**:`agent-skills` 12.2KB(commit `c31b792`)
- ❌ **跳过跨平台分发**:Neo 9/15 决定内容跟 vibe-coding / hermes 高度重叠,跨平台价值有限
- 累计:博客 13 篇 / B 站资源 11 篇 / 微信资源 10 篇(B 站 / 微信资源仍就绪但 Neo 决定不发)
- 关联 commit:本 commit
- **下一步**:收工

### 2026-09-22 — Obsidian Sync Guide 仅博客
- 🆕 **新发 1 篇博客**:`obsidian-sync-guide` 8.8KB(commit `e304120`)
- ❌ **跳过跨平台分发**:Neo 9/22 决定跟 obsidian-overview 主题强关联(虽然互补),按"内容新鲜度"标准判断跨平台价值有限
- 累计:博客 14 篇 / B 站资源 11 篇 / 微信资源 10 篇(资源保留在 .to-publish/ 下以备未来用)
- 关联 commit:本 commit
- **下一步**:收工
