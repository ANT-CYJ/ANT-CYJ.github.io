...
var Analyzer_1 = __importDefault(require("../utils/Analyzer")); //爬取网页课程信息
//定义登录校验中间件
var checkLogin = function (req, res, next) {
    console.log("checkLogin middleware");
    var isLogin = CrowllerController.isLogin(req);
    if (isLogin) {
        next();
    }
    else {
...
var CrowllerController = /** @class */ (function () {
    ...
    CrowllerController.prototype.getData = function (req, res) {
        ...
        var analyzer = Analyzer_1.default.getInstance(); //声明为static的属性和变量可以直接被类调用
        // 实例化爬虫类
